...
extends AnAction {
    ...
    private ToolWindow getToolWindow(Project project) {
        return ToolWindowManager.getInstance(project).getToolWindow("SvgViewerEmbed");
    }
    ...
    public void actionPerformed(AnActionEvent event) {
        Project project = getProject(event);
        SvgViewerPanel viewer = SvgViewerProjectComponentEmbed.getInstance(project).getViewerPanel();
