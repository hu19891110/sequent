...
import org.ideaplugins.svgviewer.controller.project.SvgViewerProjectComponentEmbed;
...
implements ApplicationComponent, JDOMExternalizable, Configurable {
    ...
    public static final String PLUGIN_NAME = "SvgViewerEmbeded";
    ...
    public String getComponentName() {
        return SvgConfiguration.PLUGIN_NAME + "." + SvgConfiguration.CONFIGURATION_COMPONENT_NAME;
    }
    ...
    private static void enableToolWindows(boolean enableToolWindows) {
        ...
        for (Project project : projects) {
            SvgViewerProjectComponentEmbed pc = SvgViewerProjectComponentEmbed.getInstance(project);
    ...
    public static SvgConfiguration getInstance() {
        return ApplicationManager.getApplication().getComponent(SvgConfiguration.class);
    }
}