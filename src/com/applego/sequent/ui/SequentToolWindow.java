...
import com.applego.sequent.action.SequentDiagramActionGroup;
...
import com.applego.sequent.toolwindow.ImageViewerPanel;
        ...
        public void documentChanged(DocumentEvent event) {
            ...
            if (!DUMMY_IDENTIFIER.equals(event.getNewFragment().toString())) {
                ...
                for (Editor editor : editors) {
                    ...
                    // TODO-PZA-Check this is needed:
                    imageViewer.renderLater(editor.getProject());
                }
            }
        }
    }
